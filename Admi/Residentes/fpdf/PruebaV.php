...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE RESIDENTES "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(53, 10, utf8_decode('APELLIDOS'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('CEDULA'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('TELEFONO'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('N° DE CASA'), 1, 1, 'C', 1);
   }
...
$consulta_info = $mysqli->query("select * from residentes");//traemos datos de la empresa desde BD
...
$consulta_reporte_residentes = $mysqli->query(" SELECT * FROM residentes");
...
$pdf->Cell(53, 10, utf8_decode("$datos_reporte->RESI_APEL"), 1, 0, 'C', 0);
$pdf->Cell(30, 10, utf8_decode("$datos_reporte->RESI_CEDU"), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("$datos_reporte->RESI_TELF"), 1, 0, 'C', 0);
$pdf->Cell(25, 10, utf8_decode("$datos_reporte->RESI_CASA"), 1, 1, 'C', 0);
}
