...
$fechaInit = date("Y-m-d", strtotime($_POST['PAGO_MESS']));
...
$sqlTrabajadores = ("SELECT * FROM pagos WHERE (fecha_ingreso>='$fechaInit' and fecha_ingreso<='$fechaFin') ORDER BY fecha_ingreso ASC");
